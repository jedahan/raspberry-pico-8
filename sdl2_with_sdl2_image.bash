...
image="minimal"
piho ls | grep -q ^$image\$ && echo "[$image] found, skipping creation" || {
  echo "[$image] Updating raspbian and removing cruft"
  piho create "$image"
